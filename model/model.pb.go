...
func (m *AllocationRequest) GetFileSize() uint64 {
	if m != nil {
		return m.FileSize
	}
	return 0
...
type AllocationResponse struct {
	...
	AvailableSpace       uint64   `protobuf:"varint,2,opt,name=availableSpace,proto3" json:"availableSpace,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AllocationResponse) GetAvailableSpace() uint64 {
	if m != nil {
...
var fileDescriptor_312ac5bcab6cbb43 = []byte{
	...
	,
}
